...
def print_state(state: State):
    ...
    print("Food distance heatmap (red=close, black=far/unreachable):")
    _print_red_heatmap(state.map[6])
    print("Self Voronoi distance heatmap (red=close, black=far/unreachable):")
    _print_red_heatmap(state.map[7])
    print("Others Voronoi distance heatmap (red=close, black=far/unreachable):")
