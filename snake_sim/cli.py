...
def add_run_config_arguments(parser):
    ...
    parser.add_argument('--ext-targets', type=str, nargs='+', help='External snake targets')
    parser.add_argument('--ext-init-timeout', type=float, help="External snake init timeout in seconds")
    parser.add_argument('--ext-conn-timeout', type=float, help="External snake connect timout in seconds")
